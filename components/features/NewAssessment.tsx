...
export default function NewAssessment() {
  const [view, setView] = useState<"assessment" | "referrals">("assessment"); // view state
    ...
    <div className="p-8 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">
          Upload a high-resolution image and provide clinical context for
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2 pt-2">
                {[
                  ...
                  {
                    id: "newOrChanging",
                    label: "New or rapidly changing lesion",
                  },
                ].map((item) => (
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Enter labs or notes..."
              ...
              <div className="pt-4 border-t border-slate-100">
                ...
                <div className="relative border-2 border-dashed border-slate-300 rounded-xl p-6 flex flex-col items-center justify-center bg-slate-50 cursor-pointer overflow-hidden">
                  <input
                    type="file"
                    accept="image/*"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
        ...
        <div className="lg:col-span-7">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm h-full min-h-[600px] flex flex-col">
            <h2 className="text-lg font-semibold text-slate-900 mb-4 border-b pb-4">
              Assessment Report
            </h2>
            ...
            {result ? (
              <div className="prose prose-slate prose-sm max-w-none flex-1 overflow-y-auto pr-2">
                ...
                <div className="mt-8 pt-6 border-t border-slate-200 flex items-center justify-between">
                  <p className="text-xs text-slate-500 italic">
                    Disclaimer: This AI analysis is informational only and does
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-slate-400">
                ...
                <p className="text-sm">
                  Upload an image and run the assessment to see the report.
                </p>
              </div>
            )}
          </div>
